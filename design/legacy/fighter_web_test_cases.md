...
- 期望：
-  - 日志包含 `Fighter 触发被动 反击战法：登记反击 将对 Orc 发动反击`
-  - 后续日志包含 `Fighter 使用 基础武器攻击`
  - 顺序为：
    - `Orc 使用 基础武器攻击`
-    - `Fighter 触发被动 反击战法：登记反击 ...`
-    - `Orc 的 基础武器攻击 对 Fighter ...`
-    - `Fighter 使用 基础武器攻击`
...
- 期望：
-  - 日志包含 `Fighter 使用 护卫架势`
-  - 日志包含 `Fighter 的 护卫架势 未产生效果`
-  - 日志包含 `Fighter 触发被动 护卫架势：登记护卫反击 将对 Orc 发动护卫反击`
  - 登记日志出现在对应攻击结果之前
