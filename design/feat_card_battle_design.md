...
| 队伍能量 | `3 + 上场人数补正` | 3 人基线为 3；4 人上阵为 4，硬上限 6 |
| 手牌上限 | `10` | 超出时不再抽入手牌 |
...
队伍能量按上场人数给动作经济补正。卡牌战斗的默认基线是 3 人小队 3 能量；Roguelike 当前上阵上限为 4 人，4 人队伍获得 4 基础能量。该规则保证整队抽牌时，每名上场角色平均至少有一次出牌窗口，同时仍通过 `energyHardCap = 6` 限制后期爆发。

抽牌数同样按上场人数补正。3 人小队每回合 5 抽；4 人队伍为 6 抽。该补正只提升手牌选择密度，不突破 `handLimit = 10`，避免扩编后新增角色卡、治疗牌、污染牌把核心行动挤出手牌。
