...
RunEncounterGroup.ENCOUNTERS = {
    ...
    [101001] = {
        ...
        level = 1,
        enemyCount = 3,
        enemyIds = { 910004, 910002, 910001 },
        initialEnergy = 90,
        speed = 1.0,
        gold = { min = 20, max = 30 },
        -- 教学战：改为 3 怪，但仍维持 easy 档，避免首战过空。
    ...
    [101002] = {
        ...
        level = 2,
        enemyCount = 4,
        enemyIds = { 910004, 910003, 910002, 910002 },
        initialEnergy = 100,
        speed = 1.0,
        gold = { min = 24, max = 38 },
    ...
    [101003] = {
        ...
        level = 4,
        enemyCount = 5,
        enemyIds = { 910005, 910004, 910003, 910002, 910002 },
        initialEnergy = 90,
        speed = 1.0,
        gold = { min = 28, max = 42 },
    ...
    [101101] = {
        ...
        -- 单人升级改版后，第二战后队伍强度爬坡更慢；首个精英进一步收缩到 5 怪。
        budget = { difficulty = "hard", pressureFactor = 0.90 },
        playerScale = { hp = 1.00, atk = 1.03, def = 1.00, energyBonus = 0 },
