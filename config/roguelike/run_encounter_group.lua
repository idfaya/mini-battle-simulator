...
RunEncounterGroup.ENCOUNTERS = {
    ...
    [101002] = {
        ...
        playerScale = { hp = 1.34, atk = 1.16, def = 1.24, energyBonus = 20 },
        enemyScale = { hp = 0.93, atk = 0.93, def = 0.93, hitDelta = 0, spellDCDelta = 0, saveDelta = -1 },
    },
    [101003] = {
        id = 101003,
        kind = "normal",
    ...
    [101101] = {
        ...
        playerScale = { hp = 1.34, atk = 1.16, def = 1.22, energyBonus = 18 },
        enemyScale = { hp = 0.95, atk = 0.95, def = 0.95, hitDelta = 0, spellDCDelta = 0 },
    },
    [101102] = {
        id = 101102,
        kind = "elite",
        ...
        level = 4,
        enemyCount = 4,
        enemyIds = { 910004, 910003, 910002, 910004 },
        initialEnergy = 120,
        speed = 1.0,
        gold = { min = 62, max = 84 },
        eliteBonus = { equipmentRoll = 1, rewardRarityBonus = 2 },
        budget = { difficulty = "easy", pressureFactor = 0.40 },
        playerScale = { hp = 1.28, atk = 1.14, def = 1.20, energyBonus = 40 },
        enemyScale = { hp = 0.95, atk = 0.95, def = 0.95, hitDelta = 0, spellDCDelta = 0 },
    },
    ...
    [101103] = {
        ...
        speed = 1.0,
        gold = { min = 30, max = 46 },
        budget = { difficulty = "easy", pressureFactor = 0.62 },
    ...
    [101104] = {
        ...
        speed = 1.0,
        gold = { min = 46, max = 64 },
        budget = { difficulty = "easy", pressureFactor = 0.46 },
        playerScale = { hp = 1.16, atk = 1.08, def = 1.12, energyBonus = 12 },
        enemyScale = { hp = 0.96, atk = 0.96, def = 0.96, hitDelta = 0, spellDCDelta = 0, saveDelta = 0 },
    },
    ...
    [101201] = {
        ...
        level = 6,
        enemyCount = 3,
        enemyIds = { 910007, 910006, 910005 },
        initialEnergy = 20,
        speed = 1.0,
        gold = { min = 96, max = 118 },
        boss = { phaseGroupId = 101201 },
        budget = { difficulty = "easy", pressureFactor = 0.72 },
        playerScale = { hp = 1.24, atk = 1.10, def = 1.18, energyBonus = 40 },
