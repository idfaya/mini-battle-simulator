...
RunEncounterGroup.ENCOUNTERS = {
    ...
    [101001] = {
        ...
        level = 1,
        enemyCount = 5,
        enemyIds = { 910002, 910002, 910002, 910002, 910001 },
        initialEnergy = 80,
        speed = 1.0,
        gold = { min = 20, max = 30 },
        playerScale = { hp = 1.00, atk = 1.08, def = 1.00, energyBonus = 0 },
        enemyScale = { hp = 0.80, atk = 2.40, def = 0.92, hitDelta = 4, spellDCDelta = 2 },
    },
    [101002] = {
        id = 101002,
        kind = "normal",
        ...
        level = 3,
        enemyCount = 6,
        enemyIds = { 910003, 910003, 910003, 910002, 910002, 910004 },
        initialEnergy = 80,
        speed = 1.0,
        gold = { min = 24, max = 38 },
    ...
    [101003] = {
        ...
        level = 6,
        enemyCount = 6,
        enemyIds = { 910005, 910004, 910003, 910003, 910002, 910002 },
        initialEnergy = 60,
        speed = 1.0,
        gold = { min = 28, max = 42 },
        playerScale = { hp = 0.96, atk = 1.04, def = 0.98, energyBonus = 0 },
        enemyScale = { hp = 0.92, atk = 2.90, def = 1.00, hitDelta = 5, spellDCDelta = 3 },
    },
    ...
    [101101] = {
        ...
        level = 5,
        enemyCount = 6,
        enemyIds = { 910005, 910004, 910004, 910003, 910002, 910002 },
        initialEnergy = 60,
        speed = 1.0,
        gold = { min = 52, max = 68 },
        eliteBonus = { relicRoll = 1, rewardRarityBonus = 1 },
        playerScale = { hp = 0.96, atk = 1.04, def = 0.98, energyBonus = 0 },
        enemyScale = { hp = 0.94, atk = 3.00, def = 1.02, hitDelta = 5, spellDCDelta = 3 },
    },
    [101102] = {
        id = 101102,
        kind = "elite",
        ...
        enemyScale = { hp = 0.96, atk = 3.30, def = 1.08, hitDelta = 6, spellDCDelta = 4 },
    },
    ...
    [101201] = {
        ...
        enemyScale = { hp = 1.02, atk = 3.80, def = 1.10, hitDelta = 7, spellDCDelta = 5, saveDelta = 1 },
    },
}
