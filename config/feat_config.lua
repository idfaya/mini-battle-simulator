...
local FEATS = {
    ...
    [FeatId(2, 3, 3)] = {
        ...
        exclusiveGroup = "class2_path",
        effects = { { type = "upgrade_skill", skillId = 80002004, skillLevel = 2 }, { type = "stat_add", hit = 1 } },
    },
    ...
    [FeatId(2, 5, 1)] = {
        ...
        effects = { { type = "upgrade_skill", skillId = 80002004, skillLevel = 2 }, { type = "stat_add", hit = 2 } },
    },
    [FeatId(2, 5, 2)] = {
    ...
    [FeatId(1, 4, 1)] = { id = FeatId(1, 4, 1), name = "属性提升", code = "5e ASI：提高命中与机动", classId = 1, minLevel = 4, tags = { "utility" }, weight = 100, effects = { { type = "stat_add", hit = 1, speed = 1 } } },
    [FeatId(1, 4, 2)] = { id = FeatId(1, 4, 2), name = "淬毒武器", code = "斩击更易附加持续压制", classId = 1, minLevel = 4, tags = { "control" }, weight = 90, effects = { { type = "stat_add", spellDC = 1, hit = 1 } } },
    ...
    [FeatId(3, 4, 1)] = { id = FeatId(3, 4, 1), name = "属性提升", code = "5e ASI：提高命中与机动", classId = 3, minLevel = 4, tags = { "utility" }, weight = 100, effects = { { type = "stat_add", hit = 1, speed = 1 } } },
    ...
    [FeatId(3, 5, 1)] = { id = FeatId(3, 5, 1), name = "拳风连缀", code = "基础连击终盘更有压制力", classId = 3, minLevel = 5, tags = { "offense", "core" }, weight = 100, effects = { { type = "upgrade_skill", skillId = 80003001, skillLevel = 3 }, { type = "stat_add", hit = 1 } } },
    ...
    [FeatId(4, 3, 2)] = { id = FeatId(4, 3, 2), name = "复仇誓约", code = "锁定裁决路线：单体惩击更强", classId = 4, minLevel = 3, tags = { "offense", "core" }, weight = 100, exclusiveGroup = "class4_path", effects = { { type = "upgrade_skill", skillId = 80004001, skillLevel = 3 }, { type = "stat_add", hit = 1 } } },
    ...
    [FeatId(4, 4, 1)] = { id = FeatId(4, 4, 1), name = "属性提升", code = "5e ASI：提高惩击与施法稳定性", classId = 4, minLevel = 4, tags = { "utility" }, weight = 100, effects = { { type = "stat_add", hit = 1, spellDC = 1 } } },
    ...
    [FeatId(5, 3, 3)] = { id = FeatId(5, 3, 3), name = "爆裂者", code = "锁定终结路线：毒爆会波及全场", classId = 5, minLevel = 3, tags = { "offense", "core" }, weight = 90, exclusiveGroup = "class5_path", effects = { { type = "upgrade_skill", skillId = 80005004, skillLevel = 2 }, { type = "stat_add", hit = 1 } } },
    [FeatId(5, 4, 1)] = { id = FeatId(5, 4, 1), name = "属性提升", code = "5e ASI：提高命中与机动", classId = 5, minLevel = 4, tags = { "utility" }, weight = 100, effects = { { type = "stat_add", hit = 1, speed = 1 } } },
    ...
    [FeatId(5, 5, 2)] = { id = FeatId(5, 5, 2), name = "压制连射", code = "单体挂毒与持续压制同步增强", classId = 5, minLevel = 5, tags = { "offense", "core" }, weight = 90, effects = { { type = "upgrade_skill", skillId = 80005001, skillLevel = 3 }, { type = "stat_add", hit = 1 } } },
    ...
    [FeatId(6, 2, 3)] = { id = FeatId(6, 2, 3), name = "惩戒火花", code = "权杖命中后追加少量神圣附伤", classId = 6, minLevel = 2, tags = { "offense" }, weight = 80, effects = { { type = "upgrade_skill", skillId = 80006001, skillLevel = 2 }, { type = "stat_add", hit = 1 } } },
    ...
    [FeatId(6, 4, 4)] = { id = FeatId(6, 4, 4), name = "圣裁引导", code = "命中与神术压制同步提升", classId = 6, minLevel = 4, tags = { "offense" }, weight = 80, effects = { { type = "stat_add", spellDC = 1, hit = 1 } } },
    ...
    [FeatId(6, 5, 3)] = { id = FeatId(6, 5, 3), name = "裁决圣火", code = "权杖打击的神圣惩戒来到终盘强度", classId = 6, minLevel = 5, tags = { "offense" }, weight = 80, effects = { { type = "upgrade_skill", skillId = 80006001, skillLevel = 3 }, { type = "stat_add", hit = 1 } } },
