...
local FEATS = {
    ...
    [FeatBuildConfig.Ids.cleric_healing_word] = {
        ...
        level = 3,
        name = "驱散基础",
        description = "获得驱散亡灵主动；同时获得裁断祷文：神圣火花命中敌人后追加 1d6 光耀伤害。",
        trunk = "T1",
        treeSlot = "T1",
        effects = {
    ...
    [FeatBuildConfig.Ids.cleric_guardian_domain] = {
        ...
        level = 5,
        name = "庇护祷言",
        description = "获得庇护祷言，CD3，持续 2 回合；我方全体 AC +1，施放时立即为最低血友军回复 1d4 并提供 4 点临时生命。",
        trunk = "T2",
        treeSlot = "T2",
        effects = {
...
local clericTree = {
    ...
    {key="b_cleric_turn_undead", classId=6, level=4, slot="B", prereqs={F.cleric_T1}, name="治愈基础", desc="获得治愈之言，CD3，为生命最低的友军回复 1d8 + 等级生命，并驱散 1 个负面。",
        effects={{type="grant_skill", skill=80006012}}},
    {key="b_cleric_heal_plus", classId=6, level=6, slot="B", prereqs={F.cleric_T1}, name="复苏基础", desc="获得复苏祷文：你的神术治疗额外 +1d8。",
        effects={{type="grant_skill", skill=80006104}}},
    {key="j_cleric_heal_master", classId=6, level=7, slot="J", prereqs={F.cleric_T1}, name="复苏精通", desc="获得治疗专精：你的神术治疗再额外 +1d8。",
        effects={{type="grant_skill", skill=80006106}}},
    {key="j_cleric_shelter_master", classId=6, level=8, slot="J", prereqs={F.cleric_T2}, name="庇护精通", desc="庇护祷言期间我方全体 AC 额外 +1；神恩庇护改为每名友军独立 1 次/回合，触发后再提供 2 点临时生命。",
        effects={{type="grant_skill", skill=80006107}, {type="modify_skill", skill=80006103, add={shelterPerUnit=true, shelterTempHpFlat=2}}}},
    {key="j_cleric_turn_master", classId=6, level=8, slot="J", prereqs={F.cleric_T1}, name="驱散精通", desc="驱散亡灵伤害额外 +1d8；若目标生命低于 25%，则可直接净化；同时获得神术专精：神圣火花命中敌人后再追加 1d6 光耀伤害。",
        effects={{type="modify_skill", skill=80006016, add={bonusDamageDice="1d8", executeThresholdPct=25}}, {type="grant_skill", skill=80006105}}},
    ...
    {key="c_cleric_heal_grandmaster", classId=6, level=10, slot="C", prereqs={F.cleric_T1}, requireAllPrerequisites=true, isCapstone=true, name="生命大师", desc="治愈之言额外治疗 2 名最低血友军，但只对主目标驱散 1 个负面。",
