...
local FEATS = {
    ...
    [FeatBuildConfig.Ids.cleric_training] = {
        ...
        level = 1,
        name = "牧师祷训",
        description = "获得圣火术：对敌军施加敏捷豁免神术伤害，失败受伤，成功免伤。",
        effects = {
    ...
    [FeatBuildConfig.Ids.cleric_healing_word] = {
        ...
        level = 1,
        name = "治愈真言",
        description = "获得治愈真言，CD3，为生命最低的友军回复 1d8 + 等级生命，并驱散 1 个负面。",
        effects = {
    ...
    [FeatBuildConfig.Ids.cleric_shelter_prayer] = {
        ...
        level = 2,
        name = "祝福基础",
        description = "获得祝福术：选择前排或后排，使该排持续 2 回合获得攻击检定 +1 与豁免检定 +1。",
        treeSlot = "B",
        prerequisites = { FeatBuildConfig.Ids.cleric_healing_word },
        effects = {
    ...
    [FeatBuildConfig.Ids.cleric_guardian_domain] = {
        ...
        level = 3,
        name = "驱散基础",
        description = "获得驱散亡灵主动。",
        trunk = "T1",
        treeSlot = "T1",
        effects = {
            { type = "grant_skill", skill = 80006016 },
        },
    },
    -- Sorcerer (classId = 7)
...
local F = {
    ...
    cleric_R = Ids.cleric_healing_word, cleric_T1 = Ids.cleric_guardian_domain, cleric_T2 = Ids.j_cleric_turn_master,
...
-- Cleric 牧师 (classId=6)
local clericTree = {
    {key="b_cleric_shelter_plus", classId=6, level=6, slot="B", prereqs={F.cleric_shelter_prayer}, name="援助熟练", desc="获得援助术；祝福术额外为被选中一排提供 4 点临时生命。",
        effects={{type="grant_skill", skill=80006103}, {type="modify_skill", skill=80006015, add={blessTempHpFlat=4}}}},
    {key="b_cleric_turn_undead", classId=6, level=6, slot="B", prereqs={F.cleric_T2}, name="驱散熟练", desc="驱散亡灵伤害额外 +1d8。",
        effects={{type="modify_skill", skill=80006016, add={bonusDamageDice="1d8"}}}},
    {key="b_cleric_heal_plus", classId=6, level=2, slot="B", prereqs={F.cleric_R}, name="复苏基础", desc="获得复苏祷文：你的神术治疗额外 +1d8。",
        effects={{type="grant_skill", skill=80006104}}},
    {key="j_cleric_heal_master", classId=6, level=4, slot="J", prereqs={F.cleric_R}, name="复苏精通", desc="获得治疗专精：你的神术治疗再额外 +1d8。",
        effects={{type="grant_skill", skill=80006106}}},
    {key="j_cleric_shelter_master", classId=6, level=8, slot="J", prereqs={F.cleric_shelter_prayer}, name="祝福精通", desc="获得祝福专精：祝福术额外使被选中一排获得 AC +2。",
        effects={{type="grant_skill", skill=80006107}, {type="modify_skill", skill=80006015, add={blessAcBonus=2}}}},
    {key="j_cleric_turn_master", classId=6, level=5, slot="T2", prereqs={F.cleric_T1}, trunk="T2", treeSlot="T2", name="驱散精通", desc="若目标生命低于 25%，则驱散亡灵可直接净化。",
        effects={{type="modify_skill", skill=80006016, add={executeThresholdPct=25}}}},
    {key="c_cleric_heal_grandmaster", classId=6, level=10, slot="C", prereqs={F.cleric_R}, requireAllPrerequisites=true, isCapstone=true, name="生命大师", desc="治愈真言额外治疗 2 名最低血友军，但只对主目标驱散 1 个负面。",
        effects={{type="modify_skill", skill=80006012, add={healLowestCount=2, dispelOnlyPrimary=true}}}},
    {key="b_cleric_basic_spell_plus", classId=6, level=2, slot="B", prereqs={Ids.cleric_training}, name="圣火熟练", desc="获得裁断祷文：圣火术命中敌人后追加 1d6 光耀伤害。",
        effects={{type="grant_skill", skill=80006102}}},
    {key="j_cleric_basic_spell_master", classId=6, level=4, slot="J", prereqs={Ids.cleric_training}, name="圣火精通", desc="获得神术专精：圣火术命中敌人后再追加 1d6 光耀伤害。",
        effects={{type="grant_skill", skill=80006105}}},
}
...
do
    ...
    local PREREQ_FIXES = {
        ...
        -- 牧师 §8.9
        { "j_cleric_heal_master",           "b_cleric_heal_plus" },
        { "j_cleric_basic_spell_master",    "b_cleric_basic_spell_plus" },
