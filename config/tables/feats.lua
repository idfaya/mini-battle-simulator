...
local FEATS = {
    ...
    [FeatBuildConfig.Ids.wizard_freezing_nova] = {
        ...
        level = 3,
        name = "冻结基础",
        description = "获得冻结新星，CD3，十字范围；霜冻目标转 FROZEN 1 回合，未霜冻施加霜冻。",
        trunk = "T1",
        treeSlot = "T1",
        effects = {
    ...
    [FeatBuildConfig.Ids.wizard_blizzard] = {
        ...
        level = 5,
        name = "暴风基础",
        description = "获得暴风雪，CD5，全体冰系基础伤害；命中霜冻目标额外 +1d6 并刷新霜冻。",
        trunk = "T2",
        treeSlot = "T2",
        effects = {
...
-- Monk 武僧 (classId=3)
local monkTree = {
    {key="b_monk_combo_plus", classId=3, level=2, slot="B", prereqs={F.monk_R}, name="连击熟练", desc="连击触发概率 +15%。",
        effects={{type="modify_skill", skill=80003101, add={comboTriggerChanceDelta=15}}}},
    {key="b_monk_combo_shadow_step", classId=3, level=2, slot="B", prereqs={F.monk_R}, name="连击影步", desc="攻击后若目标在后排，本回合 AC +1，且下次徒手打击 hit +1。",
        effects={{type="modify_skill", skill=80003011, add={hitAcDelta=1, bonusHit=1}}}},
    ...
    {key="j_monk_pulse_master", classId=3, level=4, slot="J", prereqs={F.monk_T1}, name="截脉精通", desc="徒手打击对当前 STUN 目标 +1d8。",
        effects={{type="modify_skill", skill=80003011, add={bonusVsStunDice="1d8"}}}},
    {key="j_monk_combo_master", classId=3, level=4, slot="J", prereqs={F.monk_R}, name="连击精通", desc="本回合内连击破例再触发 1 次。",
        effects={{type="modify_skill", skill=80003101, add={comboReentryOnce=1}}}},
    {key="b_monk_breath_plus", classId=3, level=7, slot="B", prereqs={F.monk_T2}, name="调息熟练", desc="明镜止水治疗 +1d4。",
        effects={{type="modify_skill", skill=80003015, add={bonusHealDice="1d4"}}}},
    {key="j_monk_breath_master", classId=3, level=8, slot="J", prereqs={F.monk_T2}, name="调息精通", desc="明镜止水 CD -1。",
        effects={{type="modify_skill", skill=80003015, add={cooldownDelta=-1}}}},
    {key="c_monk_combo_grandmaster", classId=3, level=10, slot="C", prereqs={F.monk_R}, requireAllPrerequisites=true, isCapstone=true, name="连击大师", desc="每回合第一次徒手打击命中时，连击必定触发；若目标处于 STUN，本回合连击伤害额外 +1d6。",
        effects={{type="modify_skill", skill=80003101, add={firstHitGuaranteedCombo=true, vsStunComboBonusDice="1d6"}}}},
    {key="c_monk_breath_grandmaster", classId=3, level=10, slot="C", prereqs={F.monk_T2}, isCapstone=true, name="调息大师", desc="生命低于 35% 时自动触发一次明镜止水，每场 1 次；触发后获得 4 点临时生命。",
...
local paladinTree = {
    ...
    {key="b_paladin_smite_plus", classId=4, level=6, slot="B", prereqs={F.paladin_T1}, name="惩戒熟练", desc="破邪斩伤害 +1d8。",
        effects={{type="modify_skill", skill=80004014, add={bonusDamageDice="1d8"}}}},
    {key="b_paladin_holy_mark", classId=4, level=6, slot="B", prereqs={F.paladin_T1}, name="惩戒印记", desc="破邪斩命中后目标受到所有伤害 +1 持续 1 回合。",
        effects={{type="modify_skill", skill=80004014, add={onHitVulnerableDelta=1, onHitVulnerableDuration=1}}}},
    {key="j_paladin_purify_radiance", classId=4, level=7, slot="J", prereqs={F.paladin_T1}, name="惩戒精通", desc="破邪斩 CD -1。",
        effects={{type="modify_skill", skill=80004014, add={cooldownDelta=-1}}}},
    {key="j_paladin_lay_on_master", classId=4, level=7, slot="J", prereqs={F.paladin_T2}, name="圣手精通", desc="圣手治疗 +1d4，CD -1；治疗目标额外获得 4 点临时生命。",
        effects={{type="modify_skill", skill=80004013, add={bonusHealDice="1d4", cooldownDelta=-1, postHealShield=4}}}},
    {key="j_paladin_aura_master", classId=4, level=8, slot="J", prereqs={F.paladin_T2}, name="灵光精通", desc="神圣灵光范围扩大到全队；范围内友军维持 AC +1、豁免 +1。",
    ...
    {key="c_paladin_aura_grandmaster", classId=4, level=10, slot="C", prereqs={F.paladin_T2}, requireAllPrerequisites=true, isCapstone=true, name="灵光大师", desc="神圣灵光范围内友军 AC 额外 +1；你的灵光范围计算改为永久全队。",
...
local wizardTree = {
    {key="b_wizard_frost_plus", classId=8, level=2, slot="B", prereqs={F.wizard_R}, name="霜冻熟练", desc="霜冻持续 +1 回合。",
        effects={{type="modify_skill", skill=80008002, add={dotDurationDelta=1}}}},
    {key="b_wizard_frost_armor", classId=8, level=2, slot="B", prereqs={F.wizard_R}, name="霜冻冰甲", desc="施法后获得 4 点临时生命，每场最多 2 次。",
        effects={{type="modify_skill", skill=80008001, add={onCastShield=4, onCastShieldCharges=2}}}},
    {key="b_wizard_frost_master", classId=8, level=4, slot="B", prereqs={F.wizard_R}, name="霜冻精通", desc="对霜冻目标命中额外 +1d4。",
    ...
    {key="j_wizard_freeze_master", classId=8, level=8, slot="J", prereqs={F.wizard_T1, F.wizard_T2}, name="冻结精通", desc="冻结新星与暴风雪命中 FROZEN 目标时再 +1d4；不对单纯霜冻目标生效。",
    ...
    {key="c_wizard_frost_grandmaster", classId=8, level=10, slot="C", prereqs={F.wizard_R}, requireAllPrerequisites=true, isCapstone=true, name="霜冻大师", desc="冰系技能对霜冻 / 冻结目标 hit +1、伤害 +1d4；寒霜射线命中冻结目标时刷新霜冻。",
...
do
    ...
    local PREREQ_FIXES = {
        ...
        { "c_monk_combo_grandmaster",       "j_monk_combo_master" },
        { "c_monk_combo_grandmaster",       "j_monk_pulse_master" },
        { "c_monk_breath_grandmaster",      "j_monk_breath_master" },
        -- 盗贼 §8.3
        ...
        { "j_paladin_aura_master",          "b_paladin_shelter_plus" },
        { "c_paladin_smite_master",         "j_paladin_purify_radiance" },
        { "c_paladin_aura_grandmaster",     "j_paladin_aura_master" },
        { "c_paladin_aura_grandmaster",     "b_paladin_war_cry" },
        -- 牧师 §8.9
