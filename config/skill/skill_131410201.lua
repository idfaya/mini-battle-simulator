skill_131410201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.266667,
        animationPath = "Assets/Content/Character/Villain/Killer_Frost/Ani/An_B_141_Skill_U_01.anim",
        animationname = "An_B_141_Skill_U_01",
        animatorname = "Skill",
        during = 2.266667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_KillerFrost_Skill_U_CG",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  sameFuncAsVideo = false,  timelineA = {    during = 2.233333349227,    timelinePath = "Content/Character/Villain/Killer_Frost/Timeline/U1/141_U1_1"  }}',
      ...
      cartoon = {
        TotalS = 1.533333,
        animationPath = "Assets/Content/Character/Villain/Killer_Frost/Ani/An_B_141_Skill_U_00.anim",
        animationname = "An_B_141_Skill_U_00",
        animatorname = "Skill",
        during = 1.533333,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_KillerFrost_Skill_U_CG",  triggerS = 0.7}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 2.3,
        animationPath = "Assets/Content/Character/Villain/Killer_Frost/Ani/An_B_141_Skill_U_03.anim",
        animationname = "An_B_141_Skill_U_03",
        animatorname = "Skill",
        during = 2.3,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0.6333333,
          contidion = {
            FunctionName = "a_skill_13141_2_Check"
          },
          data = "{  cSVSkillAssociate = 6,  energyDataType = 2}",
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Killer_Frost/FX_B_141_Skill_U01_02_1.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
