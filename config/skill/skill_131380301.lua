skill_131380301 = {
  ...
  actData = { {
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0.3333333,
          contidion = {
            FunctionName = "a_skill_13138_03_mainTarget"
          },
          ...
          TriggerS = 0.3333333,
          contidion = {
            FunctionName = "a_skill_13138_03_secondTarget"
          },
          data = "{  Sender = {    IDS = {}  },  Target = {    IDS = {}  },  attackType = 2,  cSVSkillAssociate = 1,  damageType = 1,  hitType = 0}",
          datatype = "DWCommon.DamageData",
          targetsSelections = {
          ...
          data = '{  AssociateBuff = 1,  preContidion = {    FunctionName = "a_skill_13138_03_secondTarget"  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 11,    markForDel = false,    tSConditions = {      Num = 0,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 0,      heroId = 0,      measureType = 0,      tSFilter = {        BuffSubType = 0,        PropertyID = 1,        buffMainType = 0,        conditionFilter = 0,        conditionFilterDirection = 0,        wpType = 0      }    }  }}',
          datatype = "DWCommon.LaunchBuff",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          TriggerS = 0.3333333,
          contidion = {
            FunctionName = "a_skill_13138_03_plusTargetCheck"
          },
          data = "{  Sender = {    IDS = {}  },  Target = {    IDS = {}  },  attackType = 2,  cSVSkillAssociate = 1,  damageType = 1,  hitType = 0}",
          datatype = "DWCommon.DamageData",
          targetsSelections = {
          ...
          data = '{  AssociateBuff = 1,  preContidion = {    FunctionName = "a_skill_13138_03_plusTargetCheck"  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 12,    markForDel = false,    tSConditions = {      Num = 0,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 0,      heroId = 0,      measureType = 0,      tSFilter = {        BuffSubType = 0,        PropertyID = 1,        buffMainType = 0,        conditionFilter = 0,        conditionFilterDirection = 0,        wpType = 0      }    }  }}',
          datatype = "DWCommon.LaunchBuff",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
