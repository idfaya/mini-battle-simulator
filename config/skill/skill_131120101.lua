skill_131120101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.166667,
        animationPath = "Assets/Content/Character/Hero/Red_Robin/Ani/An_B_112_Skill_N_01.anim",
        animationname = "An_B_112_Skill_N_01",
        animatorname = "Skill",
        during = 1.433333,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 1,    BoneName = "Bone_WP",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  binding = 1,  duringS = 0.93,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Red_Robin/FX_B_112_Skill_N_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_RedRobin_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.7000003,
        animationPath = "Assets/Content/Character/Hero/Red_Robin/Ani/An_B_112_Skill_N_01_Bwd.anim",
        animationname = "An_B_112_Skill_N_01_Bwd",
