skill_208020201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 3,
        animationPath = "Assets/Content/Character/Mon/20302/Ani/An_B_20302_Skill_U_01.anim",
        animationname = "An_B_20302_Skill_U_01",
        animatorname = "Skill",
        during = 3,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villain_Merce_Assist_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
