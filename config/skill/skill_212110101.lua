skill_212110101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.5,
        animationPath = "Assets/Content/Character/Boss/21211/Ani/An_B_21211_Skill_N_01.anim",
        animationname = "An_B_21211_Skill_N_01",
        animatorname = "Skill",
        during = 1.333333,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "FX_fire01",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  binding = 1,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_21211/FX_B_21211_Skill_N_02.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Desaad_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Boss/21211/Ani/An_B_21211_Idle_Loop.anim",
        animationname = "An_B_21211_Idle_Loop",
