skill_131350301 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.5,
        animationPath = "Assets/Content/Character/Villain/Bizarro/Ani/An_B_135_Skill_S_01.anim",
        animationname = "An_B_135_Skill_S_01",
        animatorname = "Skill",
        during = 1.5,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0.9666666,
          contidion = {
            FunctionName = "a_skill_13135_03_1"
          },
          ...
          data = "{  associate = 4,  primaryType = 2}",
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Bizarro_Skill_S",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 1,
        animationPath = "Assets/Content/Character/Villain/Bizarro/Ani/An_B_135_Skill_S_01_Bwd.anim",
        animationname = "An_B_135_Skill_S_01_Bwd",
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 0,    BoneName = "",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Bizarro/FX_B_135_Skill_S01_03.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
