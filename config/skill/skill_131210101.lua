skill_131210101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.666667,
        animationPath = "Assets/Content/Character/Hero/Zatanna/Ani/An_B_121_Skill_N_01.anim",
        animationname = "An_B_121_Skill_N_01",
        animatorname = "Skill",
        during = 1.666667,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Zantana_Skill_N",  triggerS = 0}',
