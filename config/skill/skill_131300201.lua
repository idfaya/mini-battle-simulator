skill_131300201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.466667,
        animationPath = "Assets/Content/Character/Hero/Batgirl/Ani/An_B_130_Skill_U_01.anim",
        animationname = "An_B_130_Skill_U_01",
        animatorname = "Skill",
        during = 1.466667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  HitBoneData = {    AttachType = 1,    BoneName = "Hit2",    RelativePoint = 2,    RelativePointName = "Cha_RP_center",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  IsTargetSelect = false,  LaunchBoneData = {    AttachType = 1,    BoneName = "Hit2",    RelativePoint = 2,    RelativePointName = "Cha_RP_center",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SpellID = 131300205,  StartBoneData = {    AttachType = 1,    BoneName = "Hit2",    RelativePoint = 2,    RelativePointName = "Cha_RP_center",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 1    }  },  TotalS = 0.429,  preContidion = {    FunctionName = ""  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 1,    markForDel = false,    tSConditions = {      Num = 9,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 3,      heroId = 0,      measureType = 2,      tSFilter = {        PropertyID = 1,        conditionFilter = 0,        conditionFilterDirection = 0      }    }  }}',
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Batgirl/FX_B_Batgirl_Skill_U_01_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_Batgirl_Skill_U_01_01.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Batgirl/FX_B_Batgirl_Skill_U_01_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Batgirl_Skill_U_1",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 1,
        animationPath = "Assets/Content/Character/Hero/Batgirl/Ani/An_B_130_Idle_Loop.anim",
        animationname = "An_B_130_Idle_Loop",
