skill_131210201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.4,
        animationPath = "Assets/Content/Character/Hero/Zatanna/Ani/An_B_121_Skill_U_01.anim",
        animationname = "An_B_121_Skill_U_01",
        animatorname = "Skill",
        during = 2.4,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Zantana_Skill_U_CG",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  sameFuncAsVideo = false,  timelineA = {    during = 2.5333333333333,    timelinePath = "Content/Character/Hero/Zatanna/TimeLine/U1/121_U1_1"  }}',
      ...
      cartoon = {
        TotalS = 1.5,
        animationPath = "Assets/Content/Character/Hero/Zatanna/Ani/An_B_121_Skill_U_03.anim",
        animationname = "An_B_121_Skill_U_03",
        animatorname = "Skill",
        during = 1.5,
        triggerS = 0
      },
