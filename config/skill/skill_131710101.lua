skill_131710101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.133333,
        animationPath = "Assets/Content/Character/Villain/Two_Face/Ani/An_B_171_Skill_N_01.anim",
        animationname = "An_B_171_Skill_N_01",
        animatorname = "Skill",
        during = 2.133333,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_TwoFace_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.6666669,
        animationPath = "Assets/Content/Character/Villain/Two_Face/Ani/An_B_171_Idle_Loop.anim",
        animationname = "An_B_171_Idle_Loop",
