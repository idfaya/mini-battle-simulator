skill_200020101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.333333,
        animationPath = "Assets/Content/Character/Mon/20002/Ani/An_B_20002_Skill_N_01.anim",
        animationname = "An_B_20002_Skill_N_01",
        animatorname = "Skill",
        during = 1.333333,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  HitBoneData = {    AttachType = 1,    BoneName = "Hit2",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 201    },    offset = {      x = 0,      y = 0,      z = 0    }  },  IsTargetSelect = false,  LaunchBoneData = {    AttachType = 1,    BoneName = "",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SpellID = 200020101,  StartBoneData = {    AttachType = 1,    BoneName = "Bip001 R Hand",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  TotalS = 0.495,  preContidion = {    FunctionName = ""  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 0,    markForDel = false,    tSConditions = {      Num = 0,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 0,      heroId = 0,      measureType = 0,      tSFilter = {        PropertyID = 1,        conditionFilter = 0,        conditionFilterDirection = 0      }    }  }}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villian_Rogue_Assist_E_Skill_N",  triggerS = 0}',
