skill_212110501 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.566667,
        animationPath = "Assets/Content/Character/Mon/21203/Ani/An_B_21203_Skill_S_01_1.anim",
        animationname = "An_B_21203_Skill_S_01_1",
        animatorname = "Skill",
        during = 1.566667,
        targetsSelections = {
      ...
      contidion = {
        FunctionName = "a_skill_21211_05_checkNoTokens"
      },
      keyFrameDatas = { {
          DuringS = 0,
          TriggerS = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Ultraman_State_Weak",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 2.666667,
        animationPath = "Assets/Content/Character/Mon/21203/Ani/An_B_21203_Skill_S_01_3.anim",
        animationname = "An_B_21203_Skill_S_01_3",
        animatorname = "Skill",
        during = 2.666667,
        targetsSelections = {
          NoInheritWhenEmpty = false,
      ...
      contidion = {
        FunctionName = "a_skill_21211_05_checkHaveTokens"
      },
      keyFrameDatas = { {
          DuringS = 0.1,
          TriggerS = 0.4,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Ultraman_State_Strong",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
