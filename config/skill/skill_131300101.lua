skill_131300101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1,
        animationPath = "Assets/Content/Character/Hero/Batgirl/Ani/An_B_130_Skill_N_01.anim",
        animationname = "An_B_130_Skill_N_01",
        animatorname = "Skill",
        during = 1,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Batgirl_Skill_N",  triggerS = 0}',
