skill_193480301 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.3,
        animationPath = "Assets/Content/Character/Villain/Penguin/Ani/An_B_148_Skill_S_01_1.anim",
        animationname = "An_B_148_Skill_S_01_1",
        animatorname = "Skill",
        during = 1.3,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Penguin_Skill_S",  triggerS = 0}',
          ...
          data = '{  DuringS = 0.1,  FunctionName = "a_skill_19348_03_1",  LuaName = "",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0,
        animationPath = "Assets/Content/Character/Villain/Penguin/Ani/An_B_148_Skill_S_01_3.anim",
        animationname = "",
        animatorname = "NA",
        during = 0,
        triggerS = 0
