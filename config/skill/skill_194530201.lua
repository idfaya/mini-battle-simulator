skill_194530201 = {
  ...
  actData = { {
      ...
      keyFrameDatas = { {
          ...
          data = '{  sameFuncAsVideo = false,  timelineA = {    during = 2.1,    timelinePath = "Content/Character/Villain/Mister_Freeze/TimeLine/U1/153_U1"  }}',
