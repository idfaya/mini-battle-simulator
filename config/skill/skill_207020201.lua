skill_207020201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.766667,
        animationPath = "Assets/Content/Character/Mon/20702/Ani/An_B_20702_Skill_U_01.anim",
        animationname = "An_B_20702_Skill_U_01",
        animatorname = "Skill",
        during = 1.766667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villian_Prisoner_Assist_E_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
