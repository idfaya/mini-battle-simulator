skill_191380301 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.666667,
        animationPath = "Assets/Content/Character/Villain/Poison_Ivy/Ani/An_B_138_Skill_S_01.anim",
        animationname = "An_B_138_Skill_S_01",
        animatorname = "Skill",
        during = 1.666667,
        triggerS = 0
      },
