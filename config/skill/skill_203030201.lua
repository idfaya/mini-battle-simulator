skill_203030201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 4.033334,
        animationPath = "Assets/Content/Character/Mon/20303/Ani/An_B_20303_Skill_U_01.anim",
        animationname = "An_B_20303_Skill_U_01",
        animatorname = "Skill",
        during = 4.033334,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  AssociateBuff = 3,  preContidion = {    FunctionName = ""  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 0,    markForDel = false,    tSConditions = {      Num = 0,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 0,      heroId = 0,      measureType = 0,      tSFilter = {        BuffSubType = 0,        PropertyID = 1,        conditionFilter = 0,        conditionFilterDirection = 0      }    }  }}',
          datatype = "DWCommon.LaunchBuff",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villain_Merce_Combat_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 1.266667,
        animationPath = "Assets/Content/Character/Mon/20303/Ani/An_B_20303_Skill_U_01_Bwd.anim",
        animationname = "An_B_20303_Skill_U_01_Bwd",
