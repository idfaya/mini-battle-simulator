  ...
  actData = { {
      ...
      VideoData = {
        ...
        soundData = {
          ...
          soundid = "SE_Hero_Superman_Skill_U_CG",
          triggerS = 0
        },
        videoPath = "Superman_S_Skill.mp4"
      },
      actConditionn = {
        NotU1 = false,
        campType = 1
      ...
      cartoon = {
        TotalS = 2,
        animationPath = "Assets/Content/Character/Hero/Superman/Ani/An_B_101_Idle_loop.anim",
        animationname = "An_B_101_Idle_loop",
        animatorname = "Skill",
        during = 2,
        targetsSelections = {
          NoInheritWhenEmpty = false,
      ...
      cartoon = {
        TotalS = 3.366667,
        animationPath = "Assets/Content/Character/Hero/Superman/Ani/An_B_101_Skill_U_03.anim",
        animationname = "An_B_101_Skill_U_03",
        animatorname = "Skill",
        during = 3.366667,
        targetsSelections = {
          NoInheritWhenEmpty = false,
      ...
      keyFrameDatas = { {
          ...
          data = '{  AssociateBuff = 3,  preContidion = {    FunctionName = ""  },  targetsSelections = {    NoInheritWhenEmpty = false,    castTarget = 2,    markForDel = false,    tSConditions = {      Num = 0,      autoFullNum = false,      buffSubType = 0,      conditionDirection = 0,      heroId = 0,      measureType = 0,      tSFilter = {        BuffSubType = 0,        PropertyID = 1,        conditionFilter = 0,        conditionFilterDirection = 0,        wpType = 0      }    }  }}',
          datatype = "DWCommon.LaunchBuff",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Superman_Skill_U_1",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Superman_Skill_U_2",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  TotalS = 2.266667,  cameraBlur = {    blurRadius = 1,    centerIntensity = 1,    centerX = 0,    centerY = 0,    edgeIntensity = 1,    scaleX = 1,    scaleY = 1  },  cameraBlurDelay = 0,  cameraPrefabName = "101_U3",  cameraTimelineType = 0,  enableCameraBlur = false,  focusPoint = 0,  followTargetRotation = true}',
