skill_131850301 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.4,
        animationPath = "Assets/Content/Character/Hero/PhantomStranger/Ani/An_B_185_Skill_S_01.anim",
        animationname = "An_B_185_Skill_S_01",
        animatorname = "Skill",
        during = 2.566667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_PhantomStranger_Skill_S",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Hero/PhantomStranger/Ani/An_B_185_Idle_Loop.anim",
        animationname = "An_B_185_Idle_Loop",
