skill_208010101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.5,
        animationPath = "Assets/Content/Character/Mon/20301/Ani/An_B_20301_Skill_N_01.anim",
        animationname = "An_B_20301_Skill_N_01",
        animatorname = "Skill",
        during = 1.5,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_20301/FX_B_20301_Skill_N_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_20301/FX_B_20301_Skill_N_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villain_Merce_Tank_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.7666669,
        animationPath = "Assets/Content/Character/Mon/20301/Ani/An_B_20301_Skill_N_01_Bwd.anim",
        animationname = "An_B_20301_Skill_N_01_Bwd",
