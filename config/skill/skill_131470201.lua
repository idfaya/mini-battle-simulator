skill_131470201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.966667,
        animationPath = "Assets/Content/Character/Villain/Mirror_Master/Ani/An_B_147_Skill_U_01.anim",
        animationname = "An_B_147_Skill_U_01",
        animatorname = "Skill",
        during = 1.966667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Mirror_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
