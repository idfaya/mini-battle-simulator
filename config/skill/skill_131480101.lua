skill_131480101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.666667,
        animationPath = "Assets/Content/Character/Villain/Penguin/Ani/An_B_148_Skill_N_01.anim",
        animationname = "An_B_148_Skill_N_01",
        animatorname = "Skill",
        during = 1.666667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0,
          contidion = {
            FunctionName = "a_skill_13148_03_vfx_remove"
          },
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 0,    BoneName = "",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Penguin/FX_B_148_Skill_N_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_148_Skill_N_01.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Penguin/FX_B_148_Skill_N_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Penguin_Skill_N",  triggerS = 0}',
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0,
          contidion = {
            FunctionName = "a_skill_13148_03_vfx_add"
          },
          data = "{  cSVSkillAssociate = 0}",
          datatype = "DWCommon.ActionforceData",
          targetsSelections = {
