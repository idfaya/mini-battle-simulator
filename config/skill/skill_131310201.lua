skill_131310201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.166667,
        animationPath = "Assets/Content/Character/Villain/Lex_Luthor/Ani/An_B_131_Skill_U_01_0.anim",
        animationname = "An_B_131_Skill_U_01_0",
        animatorname = "Skill",
        during = 1.166667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Luthor/FX_B_131@Skill_U1_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Luthor/FX_B_131@Skill_U1_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Luthor_Skill_U_1",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      VideoData = {
        ...
        soundData = {
          ...
          soundid = "SE_Hero_Luthor_Skill_U_CG",
          triggerS = 0
        },
        videoPath = "Luthor_S_Skill.mp4"
      },
      actConditionn = {
        NotU1 = false,
        campType = 1
      ...
      cartoon = {
        TotalS = 1.9,
        animationPath = "Assets/Content/Character/Villain/Lex_Luthor/Ani/An_B_131_Skill_U_03.anim",
        animationname = "An_B_131_Skill_U_03",
        animatorname = "Skill",
        during = 1.933334,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = "{  associate = 1,  primaryType = 2}",
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Luthor_Skill_U_2",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = { {      Data = {        EffectPath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Luthor/FX_B_131@Skill_U3_04.prefab",        Sound = {          duringS = 0,          preContidion = {            FunctionName = ""          },          soundid = "",          triggerS = 0        },        minmaxValue = {          x = 1,          y = 1        }      },      hideFlags = 0,      name = "FX_B_131@Skill_U3_04"    } },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Luthor/FX_B_131@Skill_U3_04.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_131@Skill_U3_04.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Luthor/FX_B_131@Skill_U3_04.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  TotalS = 1.766667,  cameraBlur = {    blurRadius = 1,    centerIntensity = 1,    centerX = 0,    centerY = 0,    edgeIntensity = 1,    scaleX = 1,    scaleY = 1  },  cameraBlurDelay = 0,  cameraPrefabName = "131_U3_02",  cameraTimelineType = 1,  enableCameraBlur = false,  focusPoint = 3}',
      ...
      cartoon = {
        TotalS = 1.333333,
        animationPath = "Assets/Content/Character/Villain/Lex_Luthor/Ani/An_B_131_Idle_Loop.anim",
        animationname = "An_B_131_Idle_Loop",
