skill_210040101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.333333,
        animationPath = "Assets/Content/Character/Mon/21004/Ani/An_B_21004_Skill_N_01.anim",
        animationname = "An_B_21004_Skill_N_01",
        animatorname = "Skill",
        during = 2.333333,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 0,    BoneName = "FX_Body",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 1.5,      y = 0,      z = 0    }  },  binding = 1,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_21004/FX_B_21004_N_03.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villian_Minison_Gun_E_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Mon/21004/Ani/An_B_21004_Idle_Loop.anim",
        animationname = "An_B_21004_Idle_Loop",
