skill_131700201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.666667,
        animationPath = "Assets/Content/Character/Hero/Jessica/Ani/An_B_170_Skill_U_01.anim",
        animationname = "An_B_170_Skill_U_01",
        animatorname = "Skill",
        during = 2.666667,
        targetsSelections = {
          NoInheritWhenEmpty = false,
      ...
      keyFrameDatas = { {
          ...
          data = '{  sameFuncAsVideo = false,  timelineA = {    during = 2.6666666666667,    timelinePath = "Content/Character/Hero/Jessica/Timeline/U1/170_U1"  }}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Jessica_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      atLeastTimeS = 1.766667,
      cartoon = {
        TotalS = 1.766667,
        animationPath = "Assets/Content/Character/Hero/Jessica/Ani/An_B_170_Skill_U_03.anim",
        animationname = "An_B_170_Skill_U_03",
        animatorname = "Skill",
        during = 2.2,
        targetsSelections = {
          NoInheritWhenEmpty = false,
      ...
      keyFrameDatas = { {
          ...
          data = '{  DuringS = 0,  FunctionName = "a_skill_13170_02",  LuaName = "13170",  triggerS = 0}',
          datatype = "DWCommon.LuaData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Hero/Jessica/Ani/An_B_170_Idle_Loop.anim",
        animationname = "An_B_170_Idle_Loop",
