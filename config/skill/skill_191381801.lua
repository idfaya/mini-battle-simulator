skill_191381801 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.033333,
        animationPath = "Assets/Content/Character/Villain/Poison_Ivy/Ani/An_B_138_Skill_S_02.anim",
        animationname = "An_B_138_Skill_S_02",
        animatorname = "Skill",
        during = 2.033334,
        triggerS = 0
      },
