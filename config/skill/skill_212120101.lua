skill_212120101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1,
        animationPath = "Assets/Content/Character/Boss/21212/Ani/An_B_21212_Skill_N_01.anim",
        animationname = "An_B_21212_Skill_N_01",
        animatorname = "Skill",
        during = 0.9666667,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Steppenwolf_Skill_N",  triggerS = 0}',
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 0,    BoneName = "root",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  binding = 1,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_21212/FX_B_21212_Skill_N_02.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 0.9333333,
        animationPath = "Assets/Content/Character/Boss/21212/Ani/An_B_21212_Skill_N_01_Bwd.anim",
        animationname = "An_B_21212_Skill_N_01_Bwd",
