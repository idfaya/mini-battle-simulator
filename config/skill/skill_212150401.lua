skill_212150401 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.1,
        animationPath = "Assets/Content/Character/Hero/Martian_Manhunter/Ani/An_S_106_Idle_loop.anim",
        animationname = "An_S_106_Idle_loop",
        animatorname = "Skill",
        during = 2,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          TriggerS = 0,
          contidion = {
            FunctionName = "a_skill_21215_02_healSelf"
          },
          ...
          TriggerS = 0.6,
          contidion = {
            FunctionName = "a_skill_21215_02_bloodthirsty"
          },
          data = '{  DuringS = 0,  FunctionName = "a_skill_21215_02_bloodthirsty",  LuaName = "21215",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Hero/Martian_Manhunter/Ani/An_B_106_Idle_Loop.anim",
        animationname = "An_B_106_Idle_Loop",
