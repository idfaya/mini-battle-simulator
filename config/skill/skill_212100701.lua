skill_212100701 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.666667,
        animationPath = "Assets/Content/Character/Villain/Sinestro/Ani/An_B_133_Skill_S_01_2.anim",
        animationname = "An_B_133_Skill_S_01_2",
        animatorname = "Skill",
        during = 1.666667,
        targetsSelections = {
      ...
      keyFrameDatas = { {
          ...
          data = "{  Sender = {    IDS = {}  },  Target = {    IDS = {}  },  attributeType = 5,  cSVSkillAssociate = 1,  healType = 0}",
          ...
          TriggerS = 0,
          contidion = {
            FunctionName = "a_skill_21210_02_healSelf"
          },
