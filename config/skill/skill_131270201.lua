skill_131270201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.733333,
        animationPath = "Assets/Content/Character/Villain/Cheetah/Ani/An_B_127_Skill_U_01.anim",
        animationname = "An_B_127_Skill_U_01",
        animatorname = "Skill",
        during = 2.733334,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = { {      Data = {        EffectPath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_01.prefab",        Sound = {          duringS = 0,          preContidion = {            FunctionName = ""          },          soundid = "",          triggerS = 0        },        minmaxValue = {          x = 1,          y = 1        }      },      hideFlags = 0,      name = "FX_B_127_Skill_U3_01"    } },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_127_Skill_U3_01.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = { {      Data = {        EffectPath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_02.prefab",        Sound = {          duringS = 0,          preContidion = {            FunctionName = ""          },          soundid = "",          triggerS = 0        },        minmaxValue = {          x = 1,          y = 1        }      },      hideFlags = 0,      name = "FX_B_127_Skill_U3_02"    } },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_02.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_127_Skill_U3_02.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_02.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = { {      Data = {        EffectPath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_03.prefab",        Sound = {          duringS = 0,          preContidion = {            FunctionName = ""          },          soundid = "",          triggerS = 0        },        minmaxValue = {          x = 1,          y = 1        }      },      hideFlags = 0,      name = "FX_B_127_Skill_U3_03"    } },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_03.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_127_Skill_U3_03.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Cheetah/FX_B_127_Skill_U3_03.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  DuringS = 0,  FunctionName = "a_skill_13127_2_cast",  LuaName = "",  triggerS = 0}',
          datatype = "DWCommon.LuaData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Cheetah_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Villain/Cheetah/Ani/An_B_127_Idle_Loop.anim",
        animationname = "An_B_127_Idle_Loop",
