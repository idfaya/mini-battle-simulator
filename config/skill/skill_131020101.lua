skill_131020101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.6,
        animationPath = "Assets/Content/Character/Hero/Batman/Ani/An_B_102_Skill_N_01.anim",
        animationname = "An_B_102_Skill_N_01",
        animatorname = "Skill",
        during = 1.6,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 1,    BoneName = "Hit2",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Batman/FX_B_102_Skill_N_02.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_102_Skill_N_02.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Batman/FX_B_102_Skill_N_02.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 1,  triggerS = 0}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Batman_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.5000001,
        animationPath = "Assets/Content/Character/Hero/Batman/Ani/An_B_102_Skill_N_01_Bwd.anim",
        animationname = "An_B_102_Skill_N_01_Bwd",
