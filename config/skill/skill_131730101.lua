skill_131730101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.666667,
        animationPath = "Assets/Content/Character/Villain/Clayface/Ani/An_B_173_Skill_N_01.anim",
        animationname = "An_B_173_Skill_N_01",
        animatorname = "Skill",
        during = 1.666667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "Bip001 R Hand",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0.5,      y = 0,      z = 1.2000000476837    }  },  binding = 0,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Hero/FX_Hero_Clayface/FX_B_173_Skill_N_02.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0.033}',
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Hero_Clayface_Skill_N",  triggerS = 0}',
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Villain/Clayface/Ani/An_B_173_Idle_Loop.anim",
        animationname = "An_B_173_Idle_Loop",
