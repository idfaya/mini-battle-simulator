skill_210010201 = {
  ...
  actData = { {
      ...
      atLeastTimeS = 0.1666667,
      cartoon = {
        TotalS = 1.166667,
        animationPath = "Assets/Content/Character/Mon/21001/Ani/An_B_21001_Skill_U_01.anim",
        animationname = "An_B_21001_Skill_U_01",
        animatorname = "Skill",
        during = 6.166667,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 0,    BoneName = "",    RelativePoint = 0,    RelativePointName = "",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = { {      Data = {        EffectPath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_21001/FX_B_21001_U_01.prefab",        Sound = {          duringS = 0,          preContidion = {            FunctionName = ""          },          soundid = "",          triggerS = 0        },        minmaxValue = {          x = 1,          y = 1        }      },      hideFlags = 0,      name = "FX_B_21001_U_01"    } },  binding = 2,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_21001/FX_B_21001_U_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_21001_U_01.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_21001/FX_B_21001_U_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villain_Minison_Tank_E_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
