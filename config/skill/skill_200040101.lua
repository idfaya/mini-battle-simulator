skill_200040101 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 1.4,
        animationPath = "Assets/Content/Character/Mon/20004/Ani/An_B_20004_Skill_N_01.anim",
        animationname = "An_B_20004_Skill_N_01",
        animatorname = "Skill",
        during = 1.4,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villian_Rogue_Gun_E_Skill_N",  triggerS = 0}',
