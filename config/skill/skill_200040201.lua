skill_200040201 = {
  ...
  actData = { {
      ...
      cartoon = {
        TotalS = 2.5,
        animationPath = "Assets/Content/Character/Mon/20004/Ani/An_B_20004_Skill_U_01.anim",
        animationname = "An_B_20004_Skill_U_01",
        animatorname = "Skill",
        during = 2.5,
        triggerS = 0
      },
      ...
      keyFrameDatas = { {
          ...
          data = '{  ArenaCoordinate = {    x = 0,    y = 0,    z = 0  },  BoneData = {    AttachType = 2,    BoneName = "Bip001 R Hand",    RelativePoint = 1,    RelativePointName = "Cha_RP_down",    fieldData = {      placeType = 0    },    offset = {      x = 0,      y = 0,      z = 0    }  },  SfxCfgs = {},  binding = 1,  duringS = 0,  effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_20004/FX_B_20004_Skill_N_01.prefab",  fieldData = {    placeType = 0  },  preContidion = {    FunctionName = ""  },  scale = {    x = 0,    y = 0,    z = 0  },  sfxCfgpath = "Assets/Res/War/Sfx/FX_B_20004_Skill_N_01.asset",  sfxCfgsPath = { "Assets/Content/Prefab/SFX/FX_Mon/FX_Mon_PD_20004/FX_B_20004_Skill_N_01.prefab" },  soundData = {    duringS = 0,    preContidion = {      FunctionName = ""    },    soundid = "",    triggerS = 0  },  target = 2,  triggerS = 0}',
          datatype = "DWCommon.EffectData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
          ...
          data = '{  duringS = 0,  preContidion = {    FunctionName = ""  },  soundid = "SE_Villian_Rogue_Gun_E_Skill_U",  triggerS = 0}',
          datatype = "DWCommon.SoundData",
          targetsSelections = {
            NoInheritWhenEmpty = false,
            castTarget = 0,
      ...
      cartoon = {
        TotalS = 0.03333334,
        animationPath = "Assets/Content/Character/Mon/20004/Ani/An_B_20004_Idle_Loop.anim",
        animationname = "An_B_20004_Idle_Loop",
