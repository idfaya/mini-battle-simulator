...
buff_11940301 = {
  ...
  SEstart = {
    ...
    binding = 1,
    disappearAnimPath = "",
    effectpath = "Assets/Content/Prefab/SFX/FX_Mon/FX_weiji_003/FX_weiji_effiect_fire_sta.prefab"
  }
}
BattleDefaultTypesOpt.SetDefault(buff_11940301, BuffTemplateShow_Default, "BuffTemplateShow")