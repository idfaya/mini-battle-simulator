...
skill_800012103 = {
    ...
    meta = {
        ...
        level = 3,
        name = "感电强化",
        description = "弹射次数+2，伤害+20%",
        type = 2,  -- 1=普攻, 2=主动技, 3=大招, 4=被动
        power = 180,
        cooldown = 2,
        cost = 4,
        icon = "skill_thunder_enhance",
    },
    ...
    -- 技能参数
    -- SkillParam 参数
    skillParam = {15600, 12480, 9984, 7987, 0, 0, 0, 0, 0, 0},
...
--- 执行技能
function skill_800012103.Execute(hero, targets, skill)
    ...
    local params = skill_800012103.skillParam
    ...
    for _, target in ipairs(targets) do
        if target and target.isAlive and not target.isDead then
            ...
            -- 触发Buff
            for _, buffTrigger in ipairs(skill_800012103.buffTriggers) do
