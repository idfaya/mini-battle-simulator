...
SkillRuntimeConfig.Ids = {
    ...
    fighter_pressure_strike = 80002004,
    fighter_guard_stance = 80002005,
    fighter_second_wind = 80002101,
    fighter_pressure_style = 80002102,
    fighter_second_wind_followup = 80002103,
    fighter_counter_basic = 80002104,
    fighter_guard_counter = 80002105,
    fighter_weapon_mastery = 80002106,
    fighter_second_wind_mastery = 80002107,
    fighter_signature_mastery = 80002108,
    fighter_extra_attack = 80002109,
    fighter_extra_attack_pressure = 80002110,
    fighter_extra_attack_guard = 80002111,
}
...
local SKILLS = {
    ...
    [SkillRuntimeConfig.Ids.fighter_action_surge] = {
        ...
        execution = { type = "repeat_basic_attack", count = 2 },
    ...
    [SkillRuntimeConfig.Ids.fighter_pressure_strike] = {
        id = SkillRuntimeConfig.Ids.fighter_pressure_strike,
        symbol = "fighter_pressure_strike",
        runtimeKind = "active",
        designKind = "active",
        classId = 2,
        name = "压制打击",
        hidden = false,
        cooldown = 3,
        luaFile = "config.skill.skill_80002004",
        execution = { type = "pressure_strike" },
        tags = tags("fighter", "signature", "pressure"),
        runtimeData = {
            skillType = 2,
            skillCost = 0,
        },
    ...
    [SkillRuntimeConfig.Ids.fighter_pressure_style] = {
        id = SkillRuntimeConfig.Ids.fighter_pressure_style,
        symbol = "fighter_pressure_style",
        runtimeKind = "passive",
        designKind = "passive",
        classId = 2,
        name = "压制战法",
        ...
        tags = tags("fighter", "pressure"),
    },
    [SkillRuntimeConfig.Ids.fighter_second_wind_followup] = {
        id = SkillRuntimeConfig.Ids.fighter_second_wind_followup,
        symbol = "fighter_second_wind_followup",
        runtimeKind = "passive",
        designKind = "passive",
        classId = 2,
        name = "续战战法",
        hidden = true,
        cooldown = 0,
        trigger = "after_second_wind",
        execution = { type = "next_basic_attack_bonus" },
        tags = tags("fighter", "followup"),
    },
    [SkillRuntimeConfig.Ids.fighter_counter_basic] = {
        ...
        hidden = true,
        cooldown = 0,
        trigger = "on_melee_hit_taken_each_turn",
    ...
    [SkillRuntimeConfig.Ids.fighter_weapon_mastery] = {
        id = SkillRuntimeConfig.Ids.fighter_weapon_mastery,
        symbol = "fighter_weapon_mastery",
        runtimeKind = "passive",
        designKind = "passive",
        classId = 2,
        name = "武器专精",
        hidden = true,
        cooldown = 0,
        trigger = "basic_attack_damage_bonus",
        execution = { type = "bonus_damage" },
        tags = tags("fighter", "basic_attack", "mastery"),
    },
    ...
    [SkillRuntimeConfig.Ids.fighter_signature_mastery] = {
        id = SkillRuntimeConfig.Ids.fighter_signature_mastery,
        symbol = "fighter_signature_mastery",
        runtimeKind = "passive",
        designKind = "passive",
        classId = 2,
        name = "战技专精",
        hidden = true,
        cooldown = 0,
        trigger = "signature_skill_bonus_damage",
        execution = { type = "signature_bonus" },
        tags = tags("fighter", "signature", "mastery"),
    },
    ...
    [SkillRuntimeConfig.Ids.fighter_extra_attack_pressure] = {
        id = SkillRuntimeConfig.Ids.fighter_extra_attack_pressure,
        symbol = "fighter_extra_attack_pressure",
        runtimeKind = "passive",
        designKind = "feature",
        classId = 2,
        name = "压制者",
        hidden = true,
        cooldown = 0,
        trigger = "modify_extra_attack",
        execution = { type = "pressure_extra_attack" },
        tags = tags("fighter", "extra_attack", "pressure"),
    },
    [SkillRuntimeConfig.Ids.fighter_extra_attack_guard] = {
        id = SkillRuntimeConfig.Ids.fighter_extra_attack_guard,
        symbol = "fighter_extra_attack_guard",
        runtimeKind = "passive",
        designKind = "feature",
        classId = 2,
        name = "钢铁护卫",
        ...
        cooldown = 0,
        trigger = "modify_extra_attack",
        execution = { type = "guard_extra_attack" },
        tags = tags("fighter", "extra_attack", "guard"),
    },
}
