...
local DEF = {
    ...
    frames = {
        ...
        { frame = 24, op = "damage", effect = "skill_80003003_execute_1", targetRef = "selected", damageRate = 9000 },
        { frame = 36, op = "damage", effect = "skill_80003003_execute_2", targetRef = "selected", damageRate = 9000 },
