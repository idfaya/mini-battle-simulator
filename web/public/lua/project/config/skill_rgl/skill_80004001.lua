    ...
    return {
        {
            frame = 0,
            op = "cast",
            effect = "skill_80004001_cast",
            targets = targets,
        },
        {
            frame = 12,
            op = "execute",
            effect = "skill_80004001_execute",
            targets = targets,
            execute = function(ctx, frame)
                hero.__scriptDamageAccumulator = 0
                local result = skill_80004001.Execute(hero, targets, skill)
...
function skill_80004001.Execute(hero, targets, skill)
