...
local holySpecialResult = BattleSkill.ProcessSpecialEffects(supportCaster, { supportAlly }, holySpecial)
assert_true(holySpecialResult > 0, "ProcessSpecialEffects should resolve holy light heal")
...
local buffApplyCount = BattleSkill.ProcessSpecialEffects(supportCaster, { supportCaster, supportAlly }, buffSkill)
assert_eq(buffApplyCount, 2, "ProcessSpecialEffects should apply buff to all selected allies")
...
local poisonBurstDamage = BattleSkill.ProcessSpecialEffects(supportCaster, { poisonEnemy }, poisonBurstSkill)
assert_true(poisonBurstDamage > 0, "ProcessSpecialEffects should detonate poison damage")
