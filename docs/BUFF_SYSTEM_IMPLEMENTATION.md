...
| 890008 | 守护灵光 | GOOD | 团队 AC 与首次受击减伤 |
| 890009 | 圣域圣骑 | GOOD | 防护强化状态 |
| 890010 | 野外坚忍 | GOOD | 首次受击减伤机会标记 |
| 890011 | 神恩庇护 | GOOD | 牧师团队减伤庇护 |
| 890012 | 神圣庇护 | GOOD | 圣骑团队减伤庇护 |
| 890013 | 重甲祷法 | GOOD | 常驻防护状态 |
...
- `BAD`
- 可叠层
- `ON_ROUND_BEGIN` 时按层数结算 `Xd6` 火焰伤害
...
仓库里存在旧设计文档和历史描述，部分内容与现在实现不同。

例如：

- 早期 Buff 文档中存在按最大生命百分比结算 DoT 的描述
- 当前代码已经改为基于骰子表达的 5e 风格结算
